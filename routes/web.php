...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('reports/program-profit-loss', [ReportController::class, 'programProfitLoss'])->name('reports.program-profit-loss');
    ...
    Route::get('reports/export/program-profit-loss', [ReportController::class, 'exportProgramProfitLoss'])->name('reports.export.program-profit-loss');
